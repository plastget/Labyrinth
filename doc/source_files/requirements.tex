...
\begin{tabularx}{\textwidth}{XX}
	...
	\multicolumn{2}{>{\setlength\hsize{2\hsize}}X}{
	\textbf{Basic path} \newline
	An FPS counter is added to the playing field.
	} \\\\
	\multicolumn{2}{>{\setlength\hsize{2\hsize}}X}{
	\textbf{Exception path} \newline
	The FPS counter is created behind any object.
	} \\\\
	\multicolumn{2}{>{\setlength\hsize{2\hsize}}X}{
	\textbf{Post condition} \newline
	The FPS counter is visible and working.
	} \\\\
	\textbf{Author}				&	Christoffer, Andreas \& Gustav
\end{tabularx}
...
\begin{tabularx}{\textwidth}{XX}
	...
	\multicolumn{2}{>{\setlength\hsize{2\hsize}}X}{
	\textbf{Basic path} \newline
	A playing time timer is added to the playing field.
	} \\\\
	\multicolumn{2}{>{\setlength\hsize{2\hsize}}X}{
	\textbf{Exception path} \newline
	The playing time timer is created behind any object.
	} \\\\
	\multicolumn{2}{>{\setlength\hsize{2\hsize}}X}{
	\textbf{Post condition} \newline
	The playing time timer is visible and working.
	} \\\\
	\textbf{Author}				&	Christoffer, Andreas \& Gustav
\end{tabularx}
...
\begin{tabularx}{\textwidth}{XX}
	...
	\multicolumn{2}{>{\setlength\hsize{2\hsize}}X}{
	\textbf{Exception path} \newline
	Samsung Galaxy S2 is not running the application correctly.
	} \\\\
	\multicolumn{2}{>{\setlength\hsize{2\hsize}}X}{
	\textbf{Post condition} \newline
	Samsung Galaxy S is running the application correctly.
	} \\\\
	\textbf{Authors}				&	Christoffer, Andreas \& Gustav
\end{tabularx}
...
\begin{tabularx}{\textwidth}{XX}
	...
	\multicolumn{2}{>{\setlength\hsize{2\hsize}}X}{
	\textbf{Post condition} \newline
	Samsung Galaxy S2 is running the application correctly.
	} \\\\
	\textbf{Authors}				&	Christoffer, Andreas \& Gustav
\end{tabularx}
